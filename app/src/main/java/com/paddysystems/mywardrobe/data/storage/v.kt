...
private fun layerFromJson(
    json: JSONObject
): OutfitLayer {

    val mode =
        runCatching {
            OutfitLayerMode.valueOf(
                json.optString(
                    "mode"
                )
            )
