...
enum class WearfolioDestination { WARDROBE, ADD, OUTFITS }

@Composable
fun WearfolioBottomBar(
    selectedDestination: WearfolioDestination,
    onAddItem: () -> Unit,
    onViewOutfits: () -> Unit,
    onWardrobe: () -> Unit
) {
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            selected = selectedDestination == WearfolioDestination.WARDROBE,
            onClick = onWardrobe,
        ...
        NavigationBarItem(
            selected = selectedDestination == WearfolioDestination.ADD,
            onClick = onAddItem,
        ...
        NavigationBarItem(
            selected = selectedDestination == WearfolioDestination.OUTFITS,
