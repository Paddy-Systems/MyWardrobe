package com.paddysystems.wearfolio.ui.screens.datamanagement
...
import com.paddysystems.wearfolio.data.backup.BackupInspection
import com.paddysystems.wearfolio.data.backup.BackupProgress
import com.paddysystems.wearfolio.data.backup.WardrobeBackupService
import com.paddysystems.wearfolio.data.backup.WardrobeDataSummary
...
fun DataManagementScreen(
    ...
    Column(
        ...
        SectionLabel("BACKUP")
        Text(
            "Create one portable .wearfolio file containing all wardrobes, item metadata, original photos, cut-outs, embeddings and saved fits.",
            style = MaterialTheme.typography.bodyMedium,
